    ...
    handleConnection(req, res) {
        ...
        if (lastEventId !== undefined && !Number.isNaN(lastEventId)) {
            ...
            if (replay.gapExceeded) {
                ...
                this.writeToClient(client, this.formatChunk('full_sync_required', { missedFrom: lastEventId, capacity: this.ringBuffer.capacity() }, 0));
            }
            else {
