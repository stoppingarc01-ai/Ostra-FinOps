...
export const FeaturesSection: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      highlight: '0.42ms Telemetry',
      badge: 'Live Odometer',
    },
    {
      icon: Workflow,
      title: 'Intra-Family Failover Matrix',
      subtitle: 'Zero Tool Schema Jitter',
    ...
    },
    {
      ...
      description: 'Zero code modifications. Simply point your agent or SDK Base URL to 127.0.0.1:8080 for immediate, zero-latency interception.',
    ...
    },
    {
      ...
      description: 'Scans and masks internal IPs, credentials, JWTs, and API tokens in 0.18ms before any byte hits upstream LLM providers.',
